...
python data/enwiki/prepare_data.py --clean --out_dir="$run_dir/max_vocab" --tokenizer_path="experiment/run3/increase_iter5/tokenizer.json"
...
python data/enwiki/prepare_data.py --clean --out_dir="$run_dir/min_vocab" --tokenizer_path="experiment/run3/base/tokenizer.json"
