...
python train_spline.py config/train_enwiki_char_spline.py --out_dir="$run_dir/base"
python eval.py --model_type="SplineGPT" --out_dir="$run_dir/base" --run_idx=0

# train spline-gpt (1st layer token embedding enhancement)
python train_spline.py config/train_enwiki_char_spline.py --out_dir="$run_dir/layer1"
...
python train_spline.py config/train_enwiki_char_spline.py --out_dir="$run_dir/layer2"
...
python train_spline.py config/train_enwiki_char_spline.py --out_dir="$run_dir/layer3"
...
python train_spline.py config/train_enwiki_char_spline.py --out_dir="$run_dir/layer4"
