...
python eval.py --model_type="GPT" --out_dir="$run_dir/iter2" --run_idx=2
...
python eval.py --model_type="GPT" --out_dir="$run_dir/iter3" --run_idx=3
...
python eval.py --model_type="GPT" --out_dir="$run_dir/iter4" --run_idx=4